 ...
 * @author Window 11
 */
@WebServlet(name = "ShipperOrderList", urlPatterns = {"/ShipperOrderList"})
public class ShipperOrderList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Status> selectWhenWaitTake= sdao.getListStatusSelectWhenWaitTake();
        ...
        request.setAttribute("selectWhenWaitTake", selectWhenWaitTake);
