...
public class delivered extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (id == 1) {
                int totalOrders = odao.countOrdersByStatusIDAndUserID(12, user.getUserID());
                int totalPages = (int) Math.ceil((double) totalOrders / pageSize);
                List<Order> list = odao.getUserOrdersByPageAndStatusID(offset, pageSize, user.getUserID(), 12);
                ...
                int totalOrders = odao.countOrdersByStatusID(12);
                int totalPages = (int) Math.ceil((double) totalOrders / pageSize);
                List<Order> orderlist = odao.getOrdersByPageandStatus(offset, pageSize, 12);
                request.setAttribute("udao", udao);
