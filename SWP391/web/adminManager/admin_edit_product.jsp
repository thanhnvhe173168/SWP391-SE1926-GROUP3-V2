                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="category_id" class="form-control" id="exampleSelect1">
                                        <c:forEach items="${requestScope.LIST_CATEGORIES}" var="cat">
                                            <option ${cat.getId() == pcategory.getId() ? "selected" : ""} value="${cat.getId()}">${cat.getCategory_name()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div id="myfileupload">
                                        <input multiple type="file" id="uploadfile" name="product_img" value="${pimages}" onchange="readURL(this);" />
                                    </div>
                                    <div id="thumbbox">
