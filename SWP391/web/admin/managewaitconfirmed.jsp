<%-- 
    Document   : managewaitconfirmed
    Created on : Jun 13, 2025, 1:41:41 AM
    Author     : Window 11
--%>
...
<html>
    <head>
        ...
        <title>Manage wait confirm Page</title>
        <style>
            body {
            ...
            <table border="1">
                ...
                <c:forEach items="${lists}" var="order">
                    <tr>
                        ...
                        <td><button onclick="window.location.href = 'ConfirmOrder?id=${order.orderID}'">Xác nhận đơn</button></td>
                    </tr>
                </c:forEach>
            </table>
