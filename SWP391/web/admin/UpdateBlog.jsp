        ...
        <div class="d-flex">
            <jsp:include page="/components/AdminSidebar.jsp"></jsp:include>
                <div style="height: calc(100vh - 86px); overflow: hidden auto;" class="container">
                    <p style="color: #dd3726; font-size: 40px; font-weight: 700">Chỉnh sửa blog</p>
                    <div class="container">
                        <form id="formUpdateBlog" accept-charset="UTF-8">
                            <input 
                                type="hidden" 
                                required 
                                class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="editor" name="content" style="height: 120px"><%=blog.getContent()%></textarea>
                        </div>
