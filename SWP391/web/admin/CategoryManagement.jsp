    ...
    <div style="width: 100%; height: calc(100vh - 118px); overflow-y: auto" class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button type="button" class="btn btn-outline-primary" onclick="handleRedirect()">
                <i class="fa-solid fa-plus"></i> Thêm danh mục sản phẩm
            </button>
        </div>
        <div class="row">
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="updateCategory?categoryId=<%= rsCategory.getInt("CategoryID") %>" 
                                   class="btn btn-update btn-icon me-2">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <a href="deleteCategory?categoryId=<%= rsCategory.getInt("CategoryID") %>" 
