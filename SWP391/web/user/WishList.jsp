...
<div class="wishlist-container">
    ...
    <table class="table wishlist-table">
        ...
        <tr>
            ...
            <td>
                <a href="product.jsp?id=<%= rsWishlist.getInt("LaptopID") %>" class="btn btn-primary btn-custom">Xem chi tiết</a>
                <a href="AddToCart?id=<%= rsWishlist.getInt("LaptopID") %>" class="btn btn-success btn-custom ms-2">Thêm vào giỏ</a>
                <a href="removeWishList?id=<%= rsWishlist.getInt("WishlistID") %>" class="btn btn-danger btn-custom ms-2" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này?');">
