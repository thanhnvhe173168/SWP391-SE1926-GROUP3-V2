        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card laptop-card">
                    <img src="<%=rsLaptop.getString("ImageURL")%>" class="card-img-top laptop-image" alt="<%=rsLaptop.getString("LaptopName")%>">
                    <div class="card-body">
                        ...
                        <p class="card-text fw-bold"><%=rsLaptop.getInt("Price")%> VNĐ</p>
                        <a href="product.jsp?id=<%=rsLaptop.getInt("LaptopID")%>" class="btn btn-primary">View Details</a>
